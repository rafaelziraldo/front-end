...
export const startCargaTipoGasto = (data) => {
    return  ( dispatch ) => {
        console.log(data)
         post(data,'/tipoGasto/new').then(resp=>{
            toastr.options = {
...
export const startEditTipoGasto = (id,data) => {
    return  ( dispatch ) => {
        console.log(data)
         put(data,'/tipoGasto/edit/'+id).then(resp=>{
            console.log(resp.data)
            toastr.options = {
                positionClass : 'toast-bottom-right',
                hideDuration: 300,
...
export const startEliminarTipoGasto = (id) => {
    return  ( dispatch ) => {
        
         eliminar('/tipoGasto/delete/'+id).then(resp=>{
