...
export const CreateEditPartial = () => {
  ...
  const handlerSubmit = (e) => {
    ...
    if (verCreate) {
      ...
      dispatch(startCargaIngreso(formValues));
    } else {
      
      dispatch(startEditIngreso(active._id,formValues));
    }
  };
  useEffect(() => {
